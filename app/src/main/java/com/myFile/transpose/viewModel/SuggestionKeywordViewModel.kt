...
class SuggestionKeywordViewModel(application: MyApplication): ViewModel() {
...
class SuggestionKeywordViewModelFactory(private val application: MyApplication) : ViewModelProvider.Factory {
    override fun <T : ViewModel> create(modelClass: Class<T>): T {
        if (modelClass.isAssignableFrom(SuggestionKeywordViewModel::class.java)) {
            @Suppress("UNCHECKED_CAST")
            return SuggestionKeywordViewModel(application) as T
        }
