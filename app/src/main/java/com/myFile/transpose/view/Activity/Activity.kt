...
import com.myFile.transpose.view.dialog.DialogForNotification
import com.myFile.transpose.view.fragment.HomeFragment
import com.myFile.transpose.view.fragment.MyPlaylistsFragment
import com.myFile.transpose.view.fragment.VideoPlayerFragment
...
//        bindService(Intent(this, VideoService::class.java), bindConnection, BIND_AUTO_CREATE)
    ...
    private fun initFragment(){
        ...
        if (supportFragmentManager.findFragmentByTag("homeFragment") == null) {
            supportFragmentManager.beginTransaction()
                .add(binding.basicFrameLayout.id, homeFragment, "homeFragment")
                .commit()
        }

        if (supportFragmentManager.findFragmentByTag("myPlaylistFragment") == null) {
            supportFragmentManager.beginTransaction()
                .add(binding.basicFrameLayout.id, myPlaylistFragment, "myPlaylistFragment")
                .commit()
        }
