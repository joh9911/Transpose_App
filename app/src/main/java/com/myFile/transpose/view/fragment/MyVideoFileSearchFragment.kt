    ...
    private fun initRecyclerView(){
        ...
        myVideoFileItemsRecyclerViewAdapter.setItemClickListener(object: MyVideoFileItemsRecyclerViewAdapter.OnItemClickListener{
            override fun onClick(v: View, position: Int) {
                ...
                if (position >= mySearchedVideoFiles.count()) return

                val myPlaylistTitle = "MyVideoFiles"
                val nowPlaylistModel = NowPlaylistModel(myPlaylistItems, mySearchedVideoFiles[position].second, myPlaylistTitle, null)
