...
import com.myFile.transpose.adapter.HomeNationalPlaylistRecyclerViewAdapter
import com.myFile.transpose.retrofit.*
import com.myFile.transpose.adapter.HomePlaylistRecyclerViewAdapter
import com.myFile.transpose.adapter.HomePopularSongsRecyclerViewAdapter
...
class HomeFragment: Fragment() {
    ...
    private fun initViewModel(){
        ...
        val viewModelFactory = HomeFragmentViewModelFactory(application.suggestionKeywordRepository,
            application.youtubeDataRepository)
    ...
    private fun loadAllData() {
        showLoadingUI()
        viewModel.loadAllData(resources.getStringArray(R.array.publish_date_formats))
    }
